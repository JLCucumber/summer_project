...
for i in range(num_envs):
    ...
    # num_dofs = gym.get_actor_dof_count(env, ahandle)
    # efforts = np.full(num_dofs, 200.0).astype(np.float32)
    # gym.apply_actor_dof_efforts(env, ahandle, efforts)
    ...
    # gym.set_actor_dof_position_targets(env, ahandle, pos_targets)
    ...
    # gym.set_actor_dof_velocity_targets(env, ahandle, vel_targets)
